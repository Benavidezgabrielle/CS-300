...
void BinarySearchTree::PrintCourse(Node* node) {
    ...
    if (node == nullptr) {
        return;
                                                                                                                  ...
                                                                                                                  //School SNHU ----- Name Gabrielle Benavidez//
    //looks at left node
...
void main() {
    ...
    cout << "Welcome to the course viewer identify what you would like to vieww." << endl << endl;
    ...
    while (userInput != 9) {
        ...
        switch (userInput) {
            //loads the file that user chooses
        case 1:
            cout << endl;
            cout << "What file would you like to load? Default course file is Course Data.csv ";
            cin >> fileChoice;
            ...
            //prints court in order from A-Z
        case 2:
            cout << endl;
            cout << "------------------------------------------" << endl;
        ...
        case 9:
            ...
            //message if incorrect input is given, sometimes auto spams
        default:
            cout << userInput << " please try again." << endl << endl;
            break;
        }
    }
}